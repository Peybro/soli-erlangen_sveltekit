...
<div class="calendar">
	<div class="calendar-header">
		<button on:click={handlePrevMonth}><i class="bi bi-chevron-left" /></button>
		<button on:click={handleNextMonth}><i class="bi bi-chevron-right" /></button>
		<button on:click={setToday} class="setTodayBtn">Heute</button>
