		...
		info: [
			...
			},
			{
				...
				text: [
					...
					'Um Verletzungen zu vermeiden, müssen die Kunstradfahrer eine Schutzkleidung tragen, die aus Helm, Handschuhen, Knie- und Ellenbogenschützern besteht.'
				]
			},
			{
				...
				text: [
					...
					'Kunstrad bietet zudem viele gesundheitliche Vorteile. Durch die körperliche Aktivität wird der Kreislauf angeregt, die Muskulatur gestärkt und die Ausdauer verbessert. Es fördert die Körperbeherrschung und den Gleichgewichtssinn und kann somit auch als therapeutische Maßnahme eingesetzt werden.'
				]
			},
			{
				subitem: 'Fazit',
				text: [
					...
					'Wenn Sie Interesse am Kunstradfahren haben, gibt es in vielen Städten Vereine und Trainingsmöglichkeiten. Dort können Sie das Kunstradfahren erlernen und sich mit anderen Kunstradfahrern austauschen. Auch für Kinder und Jugendliche ist Kunstrad eine tolle Sportart, die neben dem sportlichen Aspekt auch die körperliche und geistige Entwicklung fördert.',
